...
<head>
	...
	<title>MedicalExam - AcessoLab</title>
	...
	<main id="conteudo">
		<div class="search-container">
			<form action="" method="get">
				<div>
					...
					<input value="<?php echo isset($_GET['busca']) ? $_GET['busca'] : '' ?>" class="inputbox"
						type="text" name="busca" placeholder="Escreva o nome">
				</div>
				<button><i class="fa-solid fa-magnifying-glass"></i></button>
			</form>


			<a class="button-38 add-pacient" href="cadastrarpaciente.php"><i class="fa-solid fa-plus"></i>Adicionar
				paciente</a>
		...
		if (mysqli_num_rows($resultado) > 0 && !isset($_GET["busca"])) {
			...
			while ($paciente = mysqli_fetch_assoc($resultado)) {
				...
				echo "<tr>";
				echo "<td data-label='NOME'><a class='delete-pac' href='apagarpaciente.php?cpf= " . $paciente['cpf'] . "' ><i class='fa-solid fa-trash'></i></a>" . $paciente['nome'] . "</td>";
				echo "<td data-label='CPF'>" . $paciente['cpf'] . "</td>";
				echo "<td class='endereco-td' data-label='ENDEREÇO'>" . $paciente['endereco'] . "</td>";
				...
				echo "<td class='last-td'> <a href='exames.php?cpf=" . $paciente['cpf'] . "'>Exames</a> </td>";
				echo "</tr>";
			}
			echo "</tbody></table>";
